...
export const ScanIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5a3.75 3.75 0 0 0-3.75 3.75v.51c0 .56.32 1.054.84 1.334L12 15.25l8.91-5.156a1.5 1.5 0 0 0 .84-1.334V8.25A3.75 3.75 0 0 0 18.25 4.5h-12.5Zm12.5 0h.008v.008h-.008V4.5Zm-12.5 0h.008v.008h-.008V4.5Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 15.25v5.25m0 0-3-1.75m3 1.75 3-1.75" />
  </svg>
);
